...
Thanks for your interest in improving `lf-hermes-memory-addon`.

## How to contribute
- Visit **LegionForge.org** for project information and updates.
- Email **info@legionforge.org** to discuss contributions, fixes, and collaboration.
